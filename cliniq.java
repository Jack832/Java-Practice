...
//methods
public static void searchname(String val)
{
for(doctor d:al)
    {
...
public static void searchid(int va)
{
for(doctor d:al)
    {
     if(va==d.did)
...
public static void searchnamep(String val)
{
for(patient p:al1)
    {
...
public static void searchmobile(int vl)
{
for(patient p:al1)
    {
     if(vl==p.pmobileno)
  ...
  if(a<3)
   {
    ...
    {
    ava=ava+1;
    System.out.println("appointment fixed at:"+ava+"docor specis"+d.dspec);
    a++;
    }
    else
    { 
